...
description: How Emma West Counselling collects, uses and protects personal information, including website hosting on Cloudflare.
...
I use this information only to operate, secure and diagnose the website, on the basis of legitimate interests under Article 6(1)(f) of the UK GDPR. Cloudflare’s [Data Processing Addendum](https://www.cloudflare.com/en-gb/cloudflare-customer-dpa/) includes the UK Addendum for transfers from the United Kingdom. Cloudflare is also certified under the EU–US Data Privacy Framework.

The website does not set cookies of its own. See the [Cookie Policy](/cookie-policy) for details.
...
You also have the right to complain to the Information Commissioner's Office (ICO), the UK's independent supervisory authority for data protection: [ico.org.uk](https://ico.org.uk)
